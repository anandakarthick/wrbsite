...
<div class="product-links">
                                ...
                                <a href="{{ !empty($product['site_url']) ? $product['site_url'] : url('sites/' . $product['slug'] . '/index.html') }}" class="product-site-link" target="_blank" rel="noopener" title="Visit product website">
