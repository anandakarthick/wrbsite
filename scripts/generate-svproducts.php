...
$images = [
    'hero.jpg' => 'images/tech/cyber-tech.jpg',
    'about.jpg' => 'images/office/team-collaboration.jpg',
    'svc-web.jpg' => 'images/cards/pipeforge.jpg',
    ...
    'work1.jpg' => 'images/cards/ka-crm.jpg',
    'work2.jpg' => 'images/tech/matrix-code.jpg',
    'work3.jpg' => 'images/office/developer-desk.jpg',
];
...
$CSS = <<<CSS
:root{--g1:#be123c;--g2:#e11d48;--g3:#fb923c;--ink:#2a0a10;--body:#4a2d35;--muted:#745560;--soft:#87656e;--bg:#150a10;--grad:linear-gradient(135deg,#be123c 0%,#e11d48 55%,#fb923c 100%)}
...
.hero{padding:9.5rem 0 0;background:linear-gradient(160deg,#1d0e15 0%,#150a10 55%,#231019 100%);position:relative;overflow:hidden}
...
/* ===== dark burgundy theme overrides ===== */
body{background:#150a10;color:#d9bfca}
h1,h2,h3,h4{color:#fff}
.sec-title{text-transform:uppercase;letter-spacing:.06em;font-size:clamp(1.5rem,3.4vw,2.1rem)}
.sec-desc{color:#b08d9b}
.btn{border-radius:999px}
.btn-outline{background:transparent;color:#f9a8c0;border-color:rgba(225,29,72,.5)}
.btn-outline:hover{background:rgba(225,29,72,.12)}
header{background:rgba(21,10,16,.85);border-bottom-color:rgba(255,255,255,.07)}
header.scrolled{background:rgba(21,10,16,.97);box-shadow:0 10px 24px rgba(0,0,0,.4)}
.brand{color:#fff}
.brand small{color:#b08d9b}
.nav ul a{color:#c39aa8}
.nav ul a:hover,.nav ul a.active{color:#fff}
.menu-btn{color:#fff}
@media(max-width:900px){.nav ul{background:rgba(21,10,16,.98)}}
.badge{background:rgba(225,29,72,.14);border-color:rgba(225,29,72,.45);color:#fb87a5;border-radius:999px}
.hero{background:radial-gradient(circle at 70% 20%,#3d0f1f 0%,#150a10 60%)}
.hero::before{background:radial-gradient(circle,rgba(251,146,60,.14),transparent 65%)}
.hero::after{background:radial-gradient(circle,rgba(225,29,72,.22),transparent 65%)}
.hero-grid{grid-template-columns:1fr;text-align:center;gap:2rem}
.hero p.lead{margin:0 auto 1.9rem;color:#c8a2b0}
.hero-cta,.hero-stats{justify-content:center}
.hero-stats b{color:#fff}
.hero-img{max-width:660px;margin:0 auto}
.hero-img img{border-color:#2a1420}
.hero-img::after{display:none}
.page-hero{background:linear-gradient(135deg,#3d0a1c,#5f1130)}
.card{background:#1f1018;border:1px solid rgba(255,255,255,.08);border-left:none;border-top:3px solid var(--g2)}
.card:hover{box-shadow:0 18px 40px rgba(225,29,72,.25);border-top-color:var(--g3)}
.card p{color:#b08d9b}
.img-card{background:#1f1018;border-color:rgba(255,255,255,.08)}
.img-card p{color:#b08d9b}
.checklist li{background:#1f1018;border-color:rgba(255,255,255,.08);color:#d9bfca}
.plan{background:#1f1018;border-color:rgba(255,255,255,.09)}
.plan p.desc{color:#b08d9b}
.plan ul li{color:#d9bfca}
.quote{background:linear-gradient(135deg,rgba(225,29,72,.12),rgba(251,146,60,.08));border-color:rgba(225,29,72,.3)}
.quote blockquote{color:#f2d7de}
.quote b{color:#fff}
details{background:#1f1018;border-color:rgba(255,255,255,.08)}
summary{color:#f2d7de}
details p{color:#b08d9b}
.ccard{background:#1f1018;border-color:rgba(255,255,255,.08)}
.ccard b{color:#fff}
.ccard span,.ccard a{color:#b08d9b}
footer{background:#0b0509;color:#a37a89}
.fbottom{color:#8a6272;border-top-color:rgba(255,255,255,.08)}
CSS;
...
<section style="background:linear-gradient(180deg,#1d0e15,#150a10)">
